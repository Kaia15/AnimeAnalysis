  ...
  "cells": [
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-946aed13-cddc-47ab-8186-9b0bdd811024')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-946aed13-cddc-47ab-8186-9b0bdd811024 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-946aed13-cddc-47ab-8186-9b0bdd811024');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "92a0d727-a081-435b-e077-c50066bd8b3a"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "_qz2TR174Pxw",
        "outputId": "fd81394a-1a11-4af3-e672-63f4626a69b9"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "18f802ab-c622-46f2-d109-3bd565df4720"
      },
      "outputs": [
        {
          "output_type": "execute_result",
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-20cb424b-a97e-4698-a4f0-bf4c2bd7c8a5\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-20cb424b-a97e-4698-a4f0-bf4c2bd7c8a5')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-20cb424b-a97e-4698-a4f0-bf4c2bd7c8a5 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-20cb424b-a97e-4698-a4f0-bf4c2bd7c8a5');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "lrV5CMD19S9-",
        "outputId": "4d4f6972-46d7-4af2-8850-be39d159be8c"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "sV4C78eI6ASd",
        "outputId": "6762f55c-162b-44cf-bd02-719a54624744"
      },
      "execution_count": null,
      "outputs": [
        {
